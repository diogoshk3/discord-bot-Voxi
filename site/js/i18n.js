...
window.VOZEN_FAQ = [
  [
    ...
    { en: "Yes — everything Vozen does today is free and stays free: all voices, all 13 games, greetings, admin tools. Vozen Premium (€4/month per server) only adds optional extras like the full voice-effect pack. Nothing you use ever moves behind a paywall.", pt: "Sim — tudo o que o Vozen faz hoje é grátis e continua grátis: todas as vozes, os 13 jogos, saudações, ferramentas de admin. O Vozen Premium (€4/mês por servidor) só acrescenta extras opcionais, como o pack completo de efeitos de voz. Nada do que usas passa para trás de um paywall." },
  ],
  [
