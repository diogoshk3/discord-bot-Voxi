export default {
  ...
  "preview.sample": "Hei, olen Voxi. kirjoita se, kuule se.",
  ...
  "setup.done": "**Kaikki valmista — Voxi on käyttövalmis.**",
  ...
  "setup.fixHint": "Korjataksesi puuttuvat: avaa palvelinasetuksissasi Voxin rooli (tai kanavan oikeudet) ja ota käyttöön kohdat, jotka on merkitty ❌.",
  ...
  "invite.noClientId": "Voxin kutsulinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "invite.link": "Lisää Voxi palvelimellesi:\n{url}",
  "vote.noClientId": "Voxin äänestyslinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "vote.link": "Äänestä Voxia (ilmaista, 12 tunnin välein) ja auta useampia löytämään se:\n{url}",
  "help.title": "Voxi — kirjoita se, kuule se.",
  "help.embedTitle": "Voxi — Komennot",
  "help.intro": "Voxi lukee tekstisi ääneen puhekanavilla — ilmaisia neuroääniä, kymmeniä kieliä.",
  ...
  "welcome.footer": "Voxi — kirjoita se, kuule se.",
